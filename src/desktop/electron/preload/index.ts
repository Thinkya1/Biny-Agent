...
const api: DesktopApi = {
  ...
  telosOverview: async (projectId) => await ipcRenderer.invoke(desktopIpc.telosOverview, projectId),
  saveTelos: async (projectId, input, expectedRevision) => await ipcRenderer.invoke(desktopIpc.saveTelos, projectId, input, expectedRevision),
