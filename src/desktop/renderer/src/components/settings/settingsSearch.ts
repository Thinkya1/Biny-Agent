...
export const settingsSearchIndex: SettingsSearchResult[] = [
  ...
  { tab: "活动记录", sectionId: "activity-overview", title: "活动记录器", description: "屏幕、OCR、输入活动与本地隐私策略", keywords: ["activity", "recorder", "活动", "截图", "ocr", "隐私"] },
  { tab: "活动记录", sectionId: "activity-capture", title: "采集参数", description: "防抖、心跳、空闲和 JPEG 质量", keywords: ["采集", "防抖", "心跳", "jpeg", "截图"] },
  { tab: "活动记录", sectionId: "activity-ocr", title: "OCR 与输入", description: "Vision OCR、语言和输入监听", keywords: ["ocr", "vision", "输入", "键盘", "鼠标"] },
  { tab: "活动记录", sectionId: "activity-sensitive-apps", title: "敏感应用", description: "永不采集的 bundle ID 列表", keywords: ["敏感", "bundle", "应用", "屏蔽"] },
  { tab: "活动记录", sectionId: "activity-storage", title: "存储配置", description: "容量上限与全局输出目录", keywords: ["存储", "目录", "jpeg", "快照"] },
