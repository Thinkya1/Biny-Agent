...
export const settingsSearchIndex: SettingsSearchResult[] = [
  ...
  { tab: "记忆", sectionId: "memory-overview", title: "记忆总览", description: "总开关与记忆数量", keywords: ["记忆", "启用", "统计", "memory"] },
  { tab: "记忆", sectionId: "memory-features", title: "自动记忆", description: "自动检索、自动生成与外部上下文", keywords: ["记忆", "检索", "生成", "memory"] },
